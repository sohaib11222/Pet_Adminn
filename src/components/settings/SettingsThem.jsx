...
const SettingsThem = () => {
  ...
  const onLightLogoChange = async (e) => {
    ...
    try {
      ...
      setLightLogoError(err?.message || "Failed to upload light logo");
    } finally {
            ...
            <form>
              ...
              <div className="form-group theme-set row">
                ...
                <div className="col-lg-7">
                  ...
                  />
                  {lightLogoError ? (
                    <div className="text-danger mt-1">{lightLogoError}</div>
                  ) : null}
                ...
                <div className="col-lg-2">
                  <div className="img-thumbnail float-end">
                    <img
                      src={lightLogoUrl ? toPublicUrl(lightLogoUrl) : image1}
                     alt="#"
                      width={40}
                      height={40}
                    />
              ...
              <div className="form-group theme-set row">
                ...
                <div className="col-lg-2">
                  <div className="settings-image img-thumbnail float-end">
                    <img
                      src={faviconUrl ? toPublicUrl(faviconUrl) : image2}
                     alt="#"
                      width={16}
                      height={16}
                    />
