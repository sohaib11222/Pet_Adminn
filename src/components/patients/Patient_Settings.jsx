                                                        ...
                                                        <div className="col-lg-4 col-md-4">
                                                            <div className="profile-user-box">
                                                                <div className="profile-user-img">
                                                                    <img src={avatarUrl ? toPublicUrl(avatarUrl) : profileuser01} alt="Profile" />
                                                                    <div className="form-group doctor-up-files profile-edit-icon mb-0">
                                                                        <div className="uplod d-flex">
                                                                            <label className="file-upload profile-upbtn mb-0">
                                                                                <img src={cameraicon} alt="Profile" /><input type="file" accept="image/*" onChange={onAvatarChange} disabled={avatarUploading} />
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                    {avatarError ? (
